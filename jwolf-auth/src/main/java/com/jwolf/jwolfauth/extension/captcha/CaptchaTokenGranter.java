package com.jwolf.jwolfauth.extension.captcha;
...
public class CaptchaTokenGranter extends AbstractTokenGranter {
    ...
    protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
        ...
        String captchaId = parameters.get("captchaId");
        Assert.isTrue(StrUtil.isNotBlank(validateCode), "验证码不能为空");
        String validateCodeKey = AuthConstant.CAPTCHA_CODE_PREFIX + captchaId;
